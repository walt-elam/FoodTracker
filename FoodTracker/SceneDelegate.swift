//
// Controls how the scene communicates with the scene delegate
//
import UIKit
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        // Called when the scene has moved from an inactive to an active state.
        // Use this method to restart any tasks that were paused (or not yet
        // started) when the scene was inactive.
    }

    func sceneWillResignActive(_ scene: UIScene) {
        // Called when the scene will move from an active to an inactive state.
        // This may occur due to temporary interruptions (ex. an incoming call).
    }
